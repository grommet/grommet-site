  ...
  next: "Moved to {date}",
        ...
        <Property name="onSelect">
          <Description>
            ...
            property makes the component read only. A second argument is also
            provided, an object with an `activeDate` property, indicating which
            date is currently active (hovered or focused).
          </Description>
          <PropertyValue type="function">
